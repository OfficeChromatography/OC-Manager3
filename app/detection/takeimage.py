...
class FixDistortionImage:
    ...
    def __init__(self, path):
        ...
        self.correction_mtx = np.array(
            [[1991.3292233320853, 0.0, 992.1223085915041],
             [0.0, 2001.2864268641247, 786.5630450127695],
             [0.0, 0.0, 1.0]])

        self.correction_dist = np.array([[-0.46707485052454495,
                                          0.23625331260723254,
                                          -0.002908698179874141,
                                          -0.00012139744702328517,
                                          -0.061287983893568314]])


        self.rotation_angle = 1.2
