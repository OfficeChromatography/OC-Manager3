...
class Derivatization_Db(core_models.Application_Db):
    class Meta(core_models.Application_Db.Meta):
        pass


class PlateProperties_Db(core_models.PlateProperties_Db):
    development = models.ForeignKey(Derivatization_Db,
...
class PressureSettings_Der_Db(models.Model):
    development = models.ForeignKey(Derivatization_Db,
...
class BandSettings_Der_Db(models.Model):
    development = models.ForeignKey(Derivatization_Db,
